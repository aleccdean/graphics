...
function render() {
  ...
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.translate(6, 0, 0));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.rotateZ(-30));
  ...
  worldFromModel = Matrix4.identity();
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.translate(12, 0, 0));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.rotateZ(180));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.rotateY(180));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.scale(1, 1.5, 1));
  shaderProgram.setUniformMatrix4fv('worldFromModel', worldFromModel.elements);
  vao.bind();
  vao.drawIndexed(gl.TRIANGLES);
  vao.unbind();
  ...
  //worldFromModel = Matrix4.identity();
  worldFromModel = Matrix4.scale(1, 1.5, 1).
                multiplyMatrix(Matrix4.translate(12, 4, 0)).
                multiplyMatrix(Matrix4.rotateZ(2*Math.PI/3 * 180/Math.PI));
  shaderProgram.setUniformMatrix4fv('worldFromModel', worldFromModel.elements);
  vao.bind();
  vao.drawIndexed(gl.TRIANGLES);
  vao.unbind();
  ...
  worldFromModel = Matrix4.identity();
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.translate(6, 6, 0));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.rotateZ(90));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.scale(0.5, -1, 1));
  shaderProgram.setUniformMatrix4fv('worldFromModel', worldFromModel.elements);
  vao.bind();
  vao.drawIndexed(gl.TRIANGLES);
  vao.unbind();
  ...
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.rotateZ(0));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.scale(1, 1, 1));
  shaderProgram.setUniformMatrix4fv('worldFromModel', worldFromModel.elements);
  vao.bind();
  vao.drawIndexed(gl.TRIANGLES);
  ...
  worldFromModel = Matrix4.identity();
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.translate(0, 6, 0));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.rotateZ(0));
  worldFromModel = worldFromModel.multiplyMatrix(Matrix4.scale(-1.5, 1, 1));
  shaderProgram.setUniformMatrix4fv('worldFromModel', worldFromModel.elements);
  vao.bind();
  vao.drawIndexed(gl.TRIANGLES);
  vao.unbind();
